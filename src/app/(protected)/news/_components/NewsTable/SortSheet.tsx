...
export default function SortSheet({
  ...
  // Значення мають відповідати тому, як бек очікує параметр "sort"
  const options: [string, string][] = [
    ['name_asc', 'Заголовок: A–Я'],
    ['name_desc', 'Заголовок: Я–A'],
    ['date_desc', 'Дата: нові → старі'], // ⬅️ заміна "brand"
    ['date_asc', 'Дата: старі → нові'], // ⬅️ нова опція
    ['status', 'Статус'],
